...
struct WatchlistView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .listStyle(.insetGrouped).navigationTitle("Watchlist").navigationBarTitleDisplayMode(.large)
    ...
    private func companyFrom(_ fav: FavoritesManager.FavoriteCompany) -> Company {
        Company(company: fav.company, ticker: fav.ticker, composite: fav.composite, industry: nil, sic_description: nil, hi_balanced: fav.isGold, hi_grade: nil, D_H: nil, D_U: nil, D_M: nil, D_A: nil, D_N: nil, decay_index: nil, decay_level: nil, shield_score: nil, shield_tier: nil, genome: nil, algo_harm: nil, humanwashing_flags: nil, domains: nil, data_sources: nil, confidence: nil, _source: nil)
    }
}
