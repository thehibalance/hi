                ...
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text("How Scoring Works")
                            .font(.system(size: 15, weight: .bold))
                            .foregroundColor(.hiNavy)
                        Text("Every company is scored 0-100 across five dimensions using 34 free public data sources. No AI in the scoring. No surveys. No pay-to-play. Companies that pass all 10 gates earn Gold HI Grade.")
                            .font(.system(size: 13))
                            .foregroundColor(.secondary)
                    }
                    .padding()
                    ...
                    VStack(spacing: 8) {
                        Link("thehibalance.org", destination: URL(string: "https://thehibalance.org")!)
                            .font(.system(size: 14, weight: .semibold))
                        Text("The HI Balance · Patent Pending · HI Grade\u{2122}")
                            .font(.system(size: 11))
                            .foregroundColor(.secondary)
