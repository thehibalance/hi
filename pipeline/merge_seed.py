...
def seed_to_pipeline(seed_entry):
    ...
    return {
        ...
        "data_sources": ["News", "Company Reports", "Industry Data"],
        ...
        "genome": {
            "H": {"scores": {"H.1": h, "H.2": h, "H.3": h, "H.4": h, "H.5": h}, "sources": ["News", "Company Reports"]},
            "U": {"scores": {"U.1": u, "U.2": u, "U.3": u, "U.4": u, "U.5": u}, "sources": ["News", "Industry Data"]},
            "M": {"scores": {"M.1": m, "M.2": m, "M.3": m, "M.4": m, "M.5": m}, "sources": ["News", "Company Reports"]},
            "A": {"scores": {"A.1": a, "A.2": a, "A.3": a, "A.4": a, "A.5": a}, "sources": ["Industry Data", "Company Reports"]},
            "N": {"scores": {"N.1": n, "N.2": n, "N.3": n, "N.4": n, "N.5": n}, "sources": ["News", "Company Reports"]},
        },
        "key_signals": {},
