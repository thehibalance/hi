...
NAME_MAP = {
    ...
    "annie's homegrown": ["annies", "annie"],
    "burt's bees": ["burts bees", "burt"],
...
def seed_to_pipeline(seed_entry):
    ...
    return {
        ...
        "confidence": "Seed (Hand-scored)",
        "data_sources": ["Seed Database"],
        "signal_coverage": "0/25 sub-signals (hand-scored)",
        "humanwashing_flags": hw_flags,
        "algo_harm": {"has_harm": False, "algo_harm_score": 0, "flags": []},
        "genome": {
            "H": {"scores": {"H.1": h, "H.2": h, "H.3": h, "H.4": h, "H.5": h}, "sources": ["Seed"]},
            "U": {"scores": {"U.1": u, "U.2": u, "U.3": u, "U.4": u, "U.5": u}, "sources": ["Seed"]},
            "M": {"scores": {"M.1": m, "M.2": m, "M.3": m, "M.4": m, "M.5": m}, "sources": ["Seed"]},
            "A": {"scores": {"A.1": a, "A.2": a, "A.3": a, "A.4": a, "A.5": a}, "sources": ["Seed"]},
            "N": {"scores": {"N.1": n, "N.2": n, "N.3": n, "N.4": n, "N.5": n}, "sources": ["Seed"]},
        },
        "key_signals": {},
