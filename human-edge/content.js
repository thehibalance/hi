...
function openDetailPanel(profile, dim) {
  ...
  panel.innerHTML = `
    ...
    <div style="background:#1B3A5C;padding:14px 16px;border-radius:0 0 14px 14px">
      ...
      <div style="font-size:8px;color:#5A7A9A;margin-top:8px;line-height:1.4;text-align:center">HI Grade Spec v1.1.0 · 3 gates: Dimensions, Evidence, Momentum · All dims ≥ 60. Estimated from public data. Not financial or legal advice.</div>
    </div>
  `;
