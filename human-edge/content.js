...
function openFullPanel(profile, filterResult, prefs) {
  ...
  panel.innerHTML = `
    ...
    <div style="background:#1B3A5C;padding:14px 16px;border-radius:0 0 14px 14px;margin-top:8px">
      ...
      <div style="font-size:8px;color:#5A7A9A;line-height:1.4;text-align:center">Spec v1.6.0 · 19 active sub-signals · 42 data sources · Estimated from public data. Not financial or legal advice.</div>
    </div>
  `;
...
function openDetailPanel(profile, dim) {
  ...
  panel.innerHTML = `
    ...
    <div style="background:#1B3A5C;padding:14px 16px;border-radius:0 0 14px 14px">
      ...
      <div style="font-size:8px;color:#5A7A9A;margin-top:8px;line-height:1.4;text-align:center">HI Grade Spec v1.6.0 · 19 active sub-signals · 42 data sources · Estimated from public data. Not financial or legal advice.</div>
    </div>
  `;
